...
export const DEFAULT_ROLE_PERMS: Record<string, string[]> = {
  ...
  partner: ['crm.pipeline', 'crm.kontakty', 'crm.kalendarz', 'crm.kalkulator'],
  menedzer: ['crm.pipeline', 'crm.kontakty', 'crm.kalendarz', 'crm.kalkulator'],
  dyrektor: ['ksiegowosc.faktury', 'ksiegowosc.bilans', 'crm.pipeline', 'crm.kontakty', 'crm.kalendarz', 'crm.kalkulator'],
